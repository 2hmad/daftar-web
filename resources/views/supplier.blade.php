...
@else direction:rtl @endif">
    ...
    <div style="display: flex;flex-direction: row;gap: 15px;">
        <a href="tel:{{ DB::table('suppliers')->where('id', '=', request()->route('id'))->value('supplier_phone') }}">
            <button class="phone"><i class="far fa-phone"></i></button>
        </a>
        <a href="sms:{{ DB::table('suppliers')->where('id', '=', request()->route('id'))->value('supplier_phone') }}">
